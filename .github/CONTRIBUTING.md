...
2. When filing a bug about exceptions or tracebacks, please include the _complete_ error if applicable. Without the complete traceback the issue might be **unsolvable** and you will be asked to provide more information.
...
There are actions that run on new PRs and if those checks fail then the PR will not be accepted, please check your code locally with `cargo clippy` and `cargo fmt`.
